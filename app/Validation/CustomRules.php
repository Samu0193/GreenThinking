...
class CustomRules
{
    ...
    public function alfaOespacio(string $str, string &$error = null): bool
    {
        // Verificar si la cadena solo contiene letras y espacios (con acentos)
        return (bool) preg_match('/^[ a-záéíóúüñ]*$/i', $str);
    }
    ...
    public function validateTelefono(string $str, string &$error = null): bool
    {
        // Acepta formato 9999-9999
        return (bool) preg_match('/^\d{4}-\d{4}$/', $str);
    }
    ...
    public function passwordMatch(string $str, string $fields, array $data): bool
    {
